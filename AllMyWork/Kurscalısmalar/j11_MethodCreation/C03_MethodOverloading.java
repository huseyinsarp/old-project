 ...
 */
        ...
        String str = "JavaCANlara selam olsun ";
            ...
            topla(35, 3.14);
            topla(3.5, 8.9);
            //topla("3", 5); ---> String - int type casting uygun olmadığı için CTE hatası verir.

        }

    public static void topla (int sayi1, int sayi2) {
        System.out.println("int - int type metod çalıştı " + (sayi1 + sayi2));

    }

    public static void topla (double sayi1, int sayi2) {
        System.out.println("double - int type metod çalıştı " + (sayi1 + sayi2));

}

    public static void topla (int sayi1, double sayi2) {
       System.out.println("int - double type metod çalıştı " + (sayi1 + sayi2));
    }

    public static void topla (double sayi1, double sayi2) {
        System.out.println("double - double type metod çalıştı " + (sayi1+sayi2));
    }
