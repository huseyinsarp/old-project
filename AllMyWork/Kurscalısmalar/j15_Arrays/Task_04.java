...
public class Task_04 {
    public static void main(String[] args) {
        // TASK -->>> Girilen bir int array elemanlarından ortalamadan büyük olan elaman sayısınıı print eden code create ediniz.

        Scanner sc = new Scanner(System.in);
        System.out.println("Kaç elemanlı array girmek istersiniz: ");
